...
func unpackImageResources(src string, dst string) error {
	...
	cmd := exec.Command("pipenv", "run", "python", "main.py", "unpack-image", srcAbs, dstAbs)
...
func unpackTextResources(src string, dst string) error {
	//TODO: Change to a direct call of Python API.
	...
	cmd := exec.Command("pipenv", "run", "python", "main.py", "unpack-text", srcAbs, dstAbs)
	cmd.Dir = "./arkwaifu-extractor"
